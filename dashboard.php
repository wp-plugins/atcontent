...
<div class="atcontent_wrap">
    <?php
        ...
        if ( ! atcontent_pingback_inline() ) {
            echo "<div class=\"error\">" . 'Could not connect to the <a href="http://atcontent.com" target=_blank>AtContent</a> server. Contact your hosting provider to solve a problem.' . "</div>";
        }
        //End PingBack
