...
Tags: affiliate, AJAX, analytics, author, automatic, blog, comment, comments, community, contact, contact form, content, counter, CSS, custom, custom post type, dashboard, database, date, del.icio.us, Digg, e-commerce, ecommerce, edit, editor, email, embed, event, events, Facebook, feed, feeds, filter, free, google, javascript, Like, link, links, list, login, mail, manage, map, maps, media, menu, meta, mobile, mp3, multisite, music, navigation, network, News, newsletter, notification, page, pages, password, paypal, performance, permalink, photo, photos, php, picture, pictures, plugin, plugins, Post, posts, search, security, seo, Share, sharing, shop, social, social media, statistics, stats, tracking, url, user, users, widget, widgets, plagiarism, anti-plagiarism, AtContent, syndication, web
...
* Interface improvements and code cleanup.
...
* Backend improvements! Email Address Encoder compatibility!

= 2.4.8 =

* Safer Email Link compatibility.
