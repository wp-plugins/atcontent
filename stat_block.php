    ...
    <div id="dashboard-table" class="b-dashboard-table_nonbg b-dashboard-table" style="margin-bottom: 0px">
        <div id="tip_two_step" class="ac_tip_show" style="padding: 10px;">
            ...
            <ol style="font-size: 1.2em;">
                <li>Get quality and relevant posts from “<a href="<?php echo admin_url( "admin.php?page=atcontent/repost.php" ); ?>">Content Feed</a>” page.<br>
                <small>Readers will come to your blog more often to read brand new content and share it on social networks! It almost double your readers engangment!</small></li>
                <li>Set tags and follow relevant bloggers in <br> your <a href="http://atcontent.com/studio/statistics?wp=1#tips" target="_blank">AtContent dashboard</a>.<br>
                <small>You will get a perfect chance on repost and reach a much wider and quality audience.</small></li>
            </ol>
            <p>
